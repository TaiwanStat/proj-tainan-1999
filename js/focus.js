function focus(area, id) {
  ...
  var  bar_width = 960 - margin.left - margin.right;
  var  bar_height = 1500 - margin.top - margin.bottom;
  ...
  d3.json("../../src/fack_areas.json", function(error, data) {
    ...
    var path = arcs.append("path")
      .attr({
        "fill": function(d, i) {
          return G.colorServiceName[array[i][0]]; //color的array
        },
        "d": arc,
        "class": "pie-path",
        "id": function(d, i) {
  ...
  d3.json("../../src/fack_items.json", function(error, data) {
    ...
    var path = arcs.append("path")
      .attr({
        "fill": function(d, i) {
          return G.colorServiceItem[i]; //color的array
        },
        "d": donut2_arc1,
        "class": "pie-path",
        "id": function(d, i) {
